          ...
          <ScrollReveal direction="left" className="lg:col-span-2">
            <div className="space-y-6">
              <div className="rounded-xl border border-border bg-white p-6">
                <h3 className="mb-2 text-lg font-semibold text-text">Let's talk</h3>
              ...
              {/* Social links */}
              <div className="rounded-xl border border-border bg-white p-6">
                <h4 className="mb-4 text-sm font-semibold text-text">Follow Me</h4>
                <div className="flex gap-3">
                  {socialLinks.map(link => (
                    <a
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-lg border border-border text-text-secondary transition-all hover:border-primary hover:text-primary hover:shadow"
                    >
                      {link.name === 'GitHub' ? (
